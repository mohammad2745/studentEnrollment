          ...
          <table id="order-listing" class="table table-striped" style="width:100%;">
            ...
            @foreach($allstudent_info as $v_student)
              <tr>
                  ...
                  <td><img src="{{ URL::to($v_student->student_image) }}" height="88" width="100" style="border-radius: 50%;"></td>
                  ...
                  <td>
                    <a href="{{ URL::to('/viewstudent/'.$v_student->student_id) }}"><button class="btn btn-outline-primary">View</button></a>
                    <a href="{{ URL::to('/editstudent/'.$v_student->student_id) }}"><button class="btn btn-outline-warning">Edit</button></a>
                    <a href="{{ URL::to('/deletestudent/'.$v_student->student_id) }}" id="delete"><button class="btn btn-outline-danger">Delete</button></a>
                  </td>
              </tr>
            @endforeach
            </tbody>
