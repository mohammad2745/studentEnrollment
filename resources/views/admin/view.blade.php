      ...
      <div class="card-body overview">
        ...
        <div class="info-links">
          <a class="social-link">
            ...
            <span>{{ $student_description_view->student_fathersname }}</span>
          </a>
          <a class="social-link">
            <i class="icon-social-facebook icon">Mother's Name:</i>
            <span>{{ $student_description_view->student_mothersname }}</span>
          </a>
          <a class="social-link">
            <i class="icon-social-facebook icon">Address:</i>
            <span>{{ $student_description_view->student_address }}</span>
          </a>
          <a class="social-link">
            <i class="icon-social-facebook icon">Department:</i>
            <span>{{ convert_department($student_description_view->student_department) }}</span>
          </a>
          <a class="social-link">
            <i class="icon-social-facebook icon">Admission Year:</i>
            <span>{{ $student_description_view->student_admissionyear }}</span>
          </a>
