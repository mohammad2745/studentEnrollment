...
<body class="sidebar-dark">
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{ route('admin_dashboard') }}"><img src="images/salt_logo.svg" alt="Logo"></a>
      </div>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="layoutsSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('tuitionfee') }}">Tuition fee</a>
                  </li>
                  <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('mec') }}">MEC</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('mba') }}">MBA</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('pec') }}">PEC</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="advancedSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('allteacher') }}">All teachers</a>
                    <a class="nav-link" href="{{ route('addteacher') }}">Add teachers</a>
                  </li>
                </ul>
              </div>
            </li>
  ...
  <script src="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/bootbox.js/5.4.0/bootbox.min.js
') }}"></script>
